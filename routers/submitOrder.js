...
//     // Fetch the seller's email using the userId from the product
...
//             to: "seller@example.com", // Seller's email address
//             subject: "New Order Received", // Email subject
//             html: `
//         <h1>New Order Received</h1>
//         <p>Here are the details of the order:</p>
...
//         res.status(200).json({ message: "Order submitted successfully! An email has been sent to the seller." });
//     } catch (error) {
//         console.error("Error processing order:", error);
//         res.status(500).json({ message: "Failed to process order. Please try again." });
//     }
